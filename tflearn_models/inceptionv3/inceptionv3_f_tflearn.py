'''
InceptionV3_version_f---4 layers(removing two inception layers a and c and retaining grid reduction and adding an extra b)
...
def construct_inceptionv3_f(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
    ...
    inception_5b_1_1 = conv_2d(inception_5a_output, 192, 1, activation=activation, name='inception_5b_1_1')

    inception_5b_3_3_reduce = conv_2d(inception_5a_output, 160, filter_size=1, activation=activation, name='inception_5b_3_3_reduce')
    inception_5b_3_3_asym_1 = conv_2d(inception_5b_3_3_reduce, 160, filter_size=[1,7],  activation=activation,name='inception_5b_3_3_asym_1')
    inception_5b_3_3 = conv_2d(inception_5b_3_3_asym_1, 192, filter_size=[7,1],  activation=activation,name='inception_5b_3_3')


    inception_5b_5_5_reduce = conv_2d(inception_5a_output, 160, filter_size=1, activation=activation, name = 'inception_5b_5_5_reduce')
    ...
    inception_5b_pool_1_1 = conv_2d(inception_5b_pool, 192, filter_size=1, activation=activation, name='inception_5b_pool_1_1')
    ...
    #grid size reduction
    inception_6a_1_1=conv_2d(inception_5b_output,192,1,activation=activation,name='inception_6a_1_1')
    inception_6a_1_3=conv_2d(inception_6a_1_1,320,3,strides=2,padding='valid',name='inception_6a_1_3')

    inception_6a_3_3_reduce = conv_2d(inception_5b_output, 192, filter_size=1, activation=activation, name='inception_6a_3_3_reduce')
    ...
    inception_6a_pool=max_pool_2d(inception_5b_output,kernel_size=3,strides=2,padding='valid')
