'''
InceptionV3_version_a---3 layers(both grid reduction layers removed)
...
def construct_inceptionv3_c(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
    ...
    inception_5a_1_1 = conv_2d(inception_3a_output, 192, 1, activation=activation, name='inception_5a_1_1')

    inception_5a_3_3_reduce = conv_2d(inception_3a_output, 128, filter_size=1, activation=activation, name='inception_5a_3_3_reduce')
    ...
    inception_5a_5_5_reduce = conv_2d(inception_3a_output, 128, filter_size=1, activation=activation, name = 'inception_5a_5_5_reduce')
    ...
    inception_7a_1_1 = conv_2d(inception_5a_output, 320, 1, activation=activation, name='inception_7a_1_1')
    inception_7a_3_3_reduce = conv_2d(inception_5a_output, 384, filter_size=1, activation=activation, name='inception_7a_3_3_reduce')
    ...
    inception_7a_5_5_reduce = conv_2d(inception_5a_output, 448, filter_size=1, activation=activation, name = 'inception_7a_5_5_reduce')
