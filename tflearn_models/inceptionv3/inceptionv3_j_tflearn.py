'''
InceptionV3_version_j---4 layers(retaining grid reduction and removing one inception layer)
...
def construct_inceptionv3_j(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
    ...
    inception_4a_1_1 = conv_2d(pool2_3_3, 96, filter_size=3,strides=2, activation=activation,name='inception_4a_1_1',padding='valid')
    ...
    inception_5a_1_1 = conv_2d(inception_4a_output, 96, 1, activation=activation, name='inception_5a_1_1')

    inception_5a_3_3_reduce = conv_2d(inception_4a_output, 64, filter_size=1, activation=activation, name='inception_5a_3_3_reduce')
    ...
    inception_5a_5_5_reduce = conv_2d(inception_4a_output, 64, filter_size=1, activation=activation, name = 'inception_5a_5_5_reduce')
    ...
    #grid size reduction
    inception_6a_1_1=conv_2d(inception_5a_output,96,1,activation=activation,name='inception_6a_1_1')
    inception_6a_1_3=conv_2d(inception_6a_1_1,80,3,strides=2,padding='valid',name='inception_6a_1_3')

    inception_6a_3_3_reduce = conv_2d(inception_5a_output, 96, filter_size=1, activation=activation, name='inception_6a_3_3_reduce')
    inception_6a_3_3_asym_1 = conv_2d(inception_6a_3_3_reduce, 96, filter_size=[1,7],  activation=activation,name='inception_6a_3_3_asym_1')
    inception_6a_3_3_asym_2 = conv_2d(inception_6a_3_3_asym_1, 96, filter_size=[7,1],  activation=activation,name='inception_6a_3_3_asym_2')
    inception_6a_3_3=conv_2d(inception_6a_3_3_asym_2,96,3,strides=2,activation=activation,padding='valid',name='inception_6a_3_3')
    ...
    inception_7a_1_1 = conv_2d(inception_6a_output, 80, 1, activation=activation, name='inception_7a_1_1')
    inception_7a_3_3_reduce = conv_2d(inception_6a_output, 96, filter_size=1, activation=activation, name='inception_7a_3_3_reduce')
    ...
    inception_7a_5_5_reduce = conv_2d(inception_6a_output, 56, filter_size=1, activation=activation, name = 'inception_7a_5_5_reduce')
