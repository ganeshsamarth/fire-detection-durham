'''
InceptionV3_version_k---4 layers(reduced one grid size reduction)(filters reduced)
...
def construct_inceptionv3_k(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
    ...
    conv3_3_3 =conv_2d(conv2_3_3, 32, 3, strides=2, activation=activation, name = 'conv3_3_3')
    ...
    conv2_7_7 =conv_2d(conv1_7_7, 64,3, strides=1, activation=activation, name='conv2_7_7_s2',padding='valid')
    ...
    inception_7a_5_5_reduce = conv_2d(inception_6a_output, 66, filter_size=1, activation=activation, name = 'inception_7a_5_5_reduce')
