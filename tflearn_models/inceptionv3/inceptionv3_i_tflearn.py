'''
InceptionV3_version_i---3 layers(both grid reduction layers removed)(filters reduced)
...
def construct_inceptionv3_i(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
