'''
InceptionV3_version_b---4 layers(reduced one grid size reduction)
...
def construct_inceptionv3_b(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
