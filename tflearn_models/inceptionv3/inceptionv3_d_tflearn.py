'''
InceptionV3_version_d---4 layers(retaining grid reduction and removing one inception layer)
...
def construct_inceptionv3_d(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
