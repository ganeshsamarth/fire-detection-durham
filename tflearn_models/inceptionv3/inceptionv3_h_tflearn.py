'''
InceptionV3_version_g---4 layers(removing one inception layers and retaining grid reduction)(c)
...
def construct_inceptionv3_h(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
    ...
    inception_4a_1_1 = conv_2d(inception_3a_output, 96, filter_size=3,strides=2, activation=activation,name='inception_4a_1_1',padding='valid')
