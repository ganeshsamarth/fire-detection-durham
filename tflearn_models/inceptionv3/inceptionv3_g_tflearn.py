'''
InceptionV3_version_g---3 layers(removing two inception layers and retaining grid reduction)(a and c)
...
def construct_inceptionv3_g(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
