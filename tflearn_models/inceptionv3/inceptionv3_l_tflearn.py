...
def construct_inceptionv3_l(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    # Build network
    ...
    inception_4a_1_1 = conv_2d(inception_3a_output, 384, filter_size=3,strides=2, activation=activation,name='inception_4a_1_1',padding='valid')

    inception_4a_5_5_reduce = conv_2d(inception_3a_output, 64, filter_size=1, activation=activation, name = 'inception_4a_5_5_reduce')
    ...
    inception_4a_pool = max_pool_2d(inception_3a_output, kernel_size=3, strides=2,padding='valid')
    ...
    inception_7a_1_1 = conv_2d(inception_6a_output, 320, 1, activation=activation, name='inception_7a_1_1')
    inception_7a_3_3_reduce = conv_2d(inception_6a_output, 384, filter_size=1, activation=activation, name='inception_7a_3_3_reduce')
    inception_7a_3_3_asym_1 = conv_2d(inception_7a_3_3_reduce, 384, filter_size=[1,3],  activation=activation,name='inception_7a_3_3_asym_1')
    inception_7a_3_3_asym_2 = conv_2d(inception_7a_3_3_reduce, 384, filter_size=[3,1],  activation=activation,name='inception_7a_3_3_asym_2')
    inception_7a_3_3=merge([inception_7a_3_3_asym_1,inception_7a_3_3_asym_2],mode='concat',axis=3)

    inception_7a_5_5_reduce = conv_2d(inception_6a_output, 448, filter_size=1, activation=activation, name = 'inception_7a_5_5_reduce')
    inception_7a_5_5_asym_1 = conv_2d(inception_7a_5_5_reduce, 384, filter_size=[3,3],  name = 'inception_7a_5_5_asym_1')
    inception_7a_5_5_asym_2 = conv_2d(inception_7a_3_3_asym_1, 384, filter_size=[1,3],  activation=activation,name='inception_7a_5_5_asym_2')
    inception_7a_5_5_asym_3 = conv_2d(inception_7a_3_3_asym_1, 384, filter_size=[3,1],  activation=activation,name='inception_7a_5_5_asym_3')
    ...
    inception_7a_pool_1_1 = conv_2d(inception_7a_pool, 192, filter_size=1, activation=activation, name='inception_7a_pool_1_1')
    ...
    inception_7b_1_1 = conv_2d(inception_7a_output, 80, 1, activation=activation, name='inception_7b_1_1')
    inception_7b_3_3_reduce = conv_2d(inception_7a_output, 192, filter_size=1, activation=activation, name='inception_7b_3_3_reduce')
    inception_7b_3_3_asym_1 = conv_2d(inception_7b_3_3_reduce, 192, filter_size=[1,3],  activation=activation,name='inception_7b_3_3_asym_1')
    inception_7b_3_3_asym_2 = conv_2d(inception_7b_3_3_reduce, 384, filter_size=[3,1],  activation=activation,name='inception_7b_3_3_asym_2')
    inception_7b_3_3=merge([inception_7b_3_3_asym_1,inception_7b_3_3_asym_2],mode='concat',axis=3)

    inception_7b_5_5_reduce = conv_2d(inception_7a_output, 448, filter_size=1, activation=activation, name = 'inception_7b_5_5_reduce')
    inception_7b_5_5_asym_1 = conv_2d(inception_7b_5_5_reduce, 384, filter_size=[3,3],  name = 'inception_7b_5_5_asym_1')
    inception_7b_5_5_asym_2 = conv_2d(inception_7b_3_3_asym_1, 384, filter_size=[1,3],  activation=activation,name='inception_7b_5_5_asym_2')
    inception_7b_5_5_asym_3 = conv_2d(inception_7b_3_3_asym_1, 384, filter_size=[3,1],  activation=activation,name='inception_7b_5_5_asym_3')
    ...
    inception_7b_pool_1_1 = conv_2d(inception_7b_pool, 192, filter_size=1, activation=activation, name='inception_7b_pool_1_1')
