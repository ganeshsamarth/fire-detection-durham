...
def construct_inceptionv2_a_4(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
	# Build network
	...
	#with tensorflow.Graph().as_default():
		...
		inception_3a_3_3 = conv_2d(inception_3a_3_3_reduce, 192, filter_size=[3, 3], activation=activation,
		...
		inception_3a_pool_1_1 = conv_2d(inception_3a_pool, 32, filter_size=1, activation=activation,
		...
		inception_3b_3_3_reduce = conv_2d(inception_3a_output, 128, filter_size=1, activation=activation,
		...
		inception_3b_5_5_reduce = conv_2d(inception_3a_output, 32, filter_size=1, activation=activation,
		...
		inception_4b_3_3_reduce = conv_2d(inception_4a_output, 128, filter_size=1, activation=activation,
		...
		inception_4b_5_5_reduce = conv_2d(inception_4a_output, 32, filter_size=1, activation=activation,
		...
		if(training):
				network = regression(loss, optimizer=optimizer,loss='categorical_crossentropy',learning_rate=0.001)
		else:
				network = loss

		model = tflearn.DNN(network, checkpoint_path='inceptionv2_a_4',best_checkpoint_path='inceptionv2_a_4_best',
