...
def construct_inceptionv2_a_6(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    ...
    inception_3a_3_3 = conv_2d(inception_3a_3_3_reduce, 192, filter_size=[3,3],  activation=activation,name='inception_3a_3_3')
    ...
    inception_3b_3_3 = conv_2d(inception_3b_3_3_reduce, 192, filter_size=[3,3],  activation=activation,name='inception_3b_3_3')
    ...
    inception_4a_3_3 = conv_2d(inception_4a_3_3_reduce, 192, filter_size=[3,3],  activation=activation,name='inception_4a_3_3')
    ...
    inception_4b_3_3 = conv_2d(inception_4b_3_3_reduce, 192, filter_size=[3,3],  activation=activation,name='inception_4b_3_3')
    ...
    inception_4c_3_3 = conv_2d(inception_4c_3_3_reduce, 192, filter_size=[3,3],  activation=activation,name='inception_4c_3_3')
    ...
    inception_4d_3_3 = conv_2d(inception_4d_3_3_reduce, 192, filter_size=[3,3],  activation=activation,name='inception_4d_3_3')
    ...
    pool5_7_7 = avg_pool_2d(inception_4d_output, kernel_size=7, strides=1)
    ...
    model = tflearn.DNN(network, checkpoint_path='inceptionv2_a_6',
