...
def construct_inceptionv2_a_5(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    ...
    model = tflearn.DNN(network, checkpoint_path='inceptionv2_a_5',
