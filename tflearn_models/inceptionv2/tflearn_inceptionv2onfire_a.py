...
def construct_inceptionv2onfire_a(x,y,normalization_method,optimizer,dropout_value,activation,training=True):
    ...
    model = tflearn.DNN(network, checkpoint_path='inceptionv2onfire_a_bn',
