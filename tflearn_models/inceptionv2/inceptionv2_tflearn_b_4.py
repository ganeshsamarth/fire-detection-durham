...
def construct_inceptionv2_b_4(x,y,normalization_method,optimizer,dropout_value,activation,training=False):
    ...
    model = tflearn.DNN(network, checkpoint_path='inceptionv2_b_4',
