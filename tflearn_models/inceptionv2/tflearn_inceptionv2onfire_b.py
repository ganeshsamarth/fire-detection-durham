...
def construct_inceptionv2onfire_b(x,y,normalization_method,optimizer,dropout_value,activation,training=False):
    ...
    model = tflearn.DNN(network, checkpoint_path='inceptiononv2onfire_b_bn',
