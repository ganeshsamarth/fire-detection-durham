...
def construct_inceptionv2_b_6(x,y,normalization_method,optimizer,dropout_value,activation,training=False):
    ...
    inception_4d_3_3_asym_1 = conv_2d(inception_4d_3_3_reduce, 192, filter_size=[1,7],  activation=activation,name='inception_4d_3_3_asym_1')
    inception_4d_3_3 = conv_2d(inception_4d_3_3_asym_1, 192, filter_size=[7,1],  activation=activation,name='inception_4d_3_3')
    ...
    model = tflearn.DNN(network, checkpoint_path='inceptionv2_b_6',
