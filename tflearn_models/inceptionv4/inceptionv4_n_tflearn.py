...
def reduction_block_a(reduction_input_a,activation):
    ...
    reduction_a_conv2_1_1=conv_2d(reduction_input_a,48,1,activation=activation,name='reduction_a_conv2_1_1')
...
def inception_block_b(input_b,activation):
    ...
    inception_b_3_3_reduce = conv_2d(input_b, 48, filter_size=1, activation=activation, name='inception_b_3_3_reduce')
    inception_b_3_3_asym_1 = conv_2d(inception_b_3_3_reduce, 56, filter_size=[1,7],  activation=activation,name='inception_b_3_3_asym_1')
    ...
    inception_b_5_5_asym_1 = conv_2d(inception_b_5_5_reduce, 48, filter_size=[7,1],  name = 'inception_b_5_5_asym_1')
...
def construct_inceptionv4_n(x,y,normalization,optimizer,dropout_value,activation,training=True):
