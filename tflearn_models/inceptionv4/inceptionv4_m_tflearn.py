...
def inception_block_c(input_c,activation):
    ...
    inception_c_5_5_asym_4 = conv_2d(inception_c_5_5_asym_2, 256, filter_size=[3,1],  activation=activation,name='inception_c_5_5_asym_3')
...
def construct_inceptionv4_m(x,y,normalization,optimizer,dropout_value,activation,training=True):
