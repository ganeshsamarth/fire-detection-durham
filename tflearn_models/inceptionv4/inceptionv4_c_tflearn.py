'''
InceptionV4-version_c 1-1-1 reducing the stem and the number of filters in each layer to half or lesser
...
def reduction_block_a(reduction_input_a,activation):
    reduction_a_conv1_1_1=conv_2d(reduction_input_a,192,3,strides=2,padding='valid',activation=activation,name='reduction_a_conv1_1_1')

    reduction_a_conv2_1_1=conv_2d(reduction_input_a,96,1,activation=activation,name='reduction_a_conv2_1_1')
    reduction_a_conv2_3_3=conv_2d(reduction_a_conv2_1_1,112,3,activation=activation,name='reduction_a_conv2_3_3')
    reduction_a_conv2_3_3_s2=conv_2d(reduction_a_conv2_3_3,128,3,strides=2,padding='valid',activation=activation,name='reduction_a_conv2_3_3_s2')
...
def inception_block_b(input_b,activation):
    inception_b_1_1 = conv_2d(input_b, 192, 1, activation=activation, name='inception_b_1_1')
    ...
    inception_b_3_3 = conv_2d(inception_b_3_3_asym_1, 128, filter_size=[7,1],  activation=activation,name='inception_b_3_3')
    ...
    inception_b_5_5_asym_2 = conv_2d(inception_b_5_5_asym_1, 112, filter_size=[1,7],  name = 'inception_b_5_5_asym_2')
    inception_b_5_5_asym_3 = conv_2d(inception_b_5_5_asym_2, 112, filter_size=[7,1],  name = 'inception_b_5_5_asym_3')
    inception_b_5_5 = conv_2d(inception_b_5_5_asym_3, 128, filter_size=[1,7],  name = 'inception_b_5_5')
...
def reduction_block_b(reduction_input_b,activation):
    ...
    reduction_b_3_3_reduce = conv_2d(reduction_input_b, 128, filter_size=1, activation=activation, name='reduction_b_3_3_reduce')
    reduction_b_3_3_asym_1 = conv_2d(reduction_b_3_3_reduce, 128, filter_size=[1,7],  activation=activation,name='reduction_b_3_3_asym_1')
    reduction_b_3_3_asym_2 = conv_2d(reduction_b_3_3_asym_1, 160, filter_size=[7,1],  activation=activation,name='reduction_b_3_3_asym_2')
    reduction_b_3_3=conv_2d(reduction_b_3_3_asym_2,160,3,strides=2,activation=activation,padding='valid',name='reduction_b_3_3')
...
def inception_block_c(input_c,activation):
    inception_c_1_1 = conv_2d(input_c, 128, 1, activation=activation, name='inception_c_1_1')
    inception_c_3_3_reduce = conv_2d(input_c, 192, filter_size=1, activation=activation, name='inception_c_3_3_reduce')
    inception_c_3_3_asym_1 = conv_2d(inception_c_3_3_reduce, 128, filter_size=[1,3],  activation=activation,name='inception_c_3_3_asym_1')
    inception_c_3_3_asym_2 = conv_2d(inception_c_3_3_reduce, 128, filter_size=[3,1],  activation=activation,name='inception_c_3_3_asym_2')
    inception_c_3_3=merge([inception_c_3_3_asym_1,inception_c_3_3_asym_2],mode='concat',axis=3)

    inception_c_5_5_reduce = conv_2d(input_c, 192, filter_size=1, activation=activation, name = 'inception_c_5_5_reduce')
    inception_c_5_5_asym_1 = conv_2d(inception_c_5_5_reduce, 112, filter_size=[1,3],  name = 'inception_c_5_5_asym_1')
    inception_c_5_5_asym_2 = conv_2d(inception_c_5_5_asym_1, 128, filter_size=[3,1],  activation=activation,name='inception_c_5_5_asym_2')
    inception_c_5_5_asym_3 = conv_2d(inception_c_5_5_asym_2, 128, filter_size=[1,3],  activation=activation,name='inception_c_5_5_asym_3')

    inception_c_5_5_asym_4 = conv_2d(inception_c_5_5_asym_2, 128, filter_size=[3,1],  activation=activation,name='inception_c_5_5_asym_4')
    ...
    inception_c_pool_1_1 = conv_2d(inception_c_pool, 128, filter_size=1, activation=activation, name='inception_c_pool_1_1')
...
def construct_inceptionv4_c(x,y,normalization,optimizer,dropout_value,activation,training=True):
   ...
   # b_conv_1=merge([b_conv_1_conv,b_conv_1_pool],mode='concat',axis=3)
    ...
    model = tflearn.DNN(network, checkpoint_path='inceptionv2',
