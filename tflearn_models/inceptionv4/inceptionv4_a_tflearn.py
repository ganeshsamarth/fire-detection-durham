...
def reduction_block_a(reduction_input_a):
    ...
    reduction_a_conv2_3_3=conv_2d(reduction_input_a,224,3,activation='relu',name='reduction_a_conv2_3_3')
...
def inception_block_c(input_c):
    ...
    inception_c_5_5_asym_2 = conv_2d(inception_c_3_3_asym_1, 512, filter_size=[3,1],  activation='relu',name='inception_c_5_5_asym_2')
    inception_c_5_5_asym_3 = conv_2d(inception_c_3_3_asym_1, 256, filter_size=[1,3],  activation='relu',name='inception_c_5_5_asym_2')

    inception_c_5_5_asym_3 = conv_2d(inception_c_3_3_asym_1, 256, filter_size=[3,1],  activation='relu',name='inception_c_5_5_asym_3')
    inception_c_5_5=merge([inception_c_5_5_asym_2,inception_c_5_5_asym_3],mode='concat',axis=3)
...
def construct_inceptionv4_a(x,y,normalization,optimizer,dropout_value,training=True):
    ...
    conv3_3_3=conv_2d(conv2_3_3,64,3,3,activation='relu',name='conv3_3_3')
