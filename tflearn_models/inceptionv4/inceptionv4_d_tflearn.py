'''
InceptionV4-version_d 1-2-1 reducing the stem and the number of filters in each layer to half or lesser
...
def construct_inceptionv4_d(x,y,normalization,optimizer,dropout_value,activation,training=True):
