...
def inception_block_c(input_c,activation):
    ...
    inception_c_5_5 = merge([inception_c_5_5_asym_3,inception_c_5_5_asym_4],mode='concat',axis=3)
...
def construct_inceptionv4_b(x,y,normalization,optimizer,dropout_value,activation,training=True):
