...
def inception_block_c(input_c,activation):
    ...
    inception_c_5_5_asym_3 = conv_2d(inception_c_5_5_asym_2, 256, filter_size=[1,3],  activation=activation,name='inception_c_5_5_asym_2')
...
def construct_inceptionv4_l(x,y,normalization,optimizer,dropout_value,activation,training=True):
    ...
    conv3_3_3=conv_2d(conv2_3_3,32,3,activation=activation,name='conv3_3_3')
    ...
    b_conv4_1_1=conv_2d(b_conv_1,32,1,activation=activation,name='conv4_3_3')
    b_conv4_3_3=conv_2d(b_conv4_1_1,48,3,padding='valid',activation=activation,name='conv5_3_3')
    ...
    b_conv5_3_3=conv_2d(b_conv_4,64,3,padding='valid',activation=activation,name='b_conv5_3_3',strides=2)
