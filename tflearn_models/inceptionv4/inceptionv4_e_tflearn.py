'''
InceptionV4-version_e 1-1-1 reducing the stem and the number of filters in each layer to half or lesser(reduction block of A removed)
...
def construct_inceptionv4_e(x,y,normalization,optimizer,dropout_value,activation,training=True):
